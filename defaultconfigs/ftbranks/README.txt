...
Last README file update: Mon Jun 14 01:36:20 ACST 2021
...
command.prune
command.prune.poi_files
command.prune.poi_files.dimension
command.prune.poi_files.dimension.dim
command.prune.poi_files.dimension.dim.do_not_backup
command.prune.poi_files.dimension.dim.do_not_backup.doNotBackup
command.prune.region_files
command.prune.region_files.dimension
command.prune.region_files.dimension.dim
command.prune.region_files.dimension.dim.do_not_backup
command.prune.region_files.dimension.dim.do_not_backup.doNotBackup
command.publish
