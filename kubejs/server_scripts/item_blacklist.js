...
global.blackListCheck = function(itemToTest, event, player) {
    if (itemToTest) {
        ...
        var itemBlackList = ['tconstruct:sword', 'tconstruct:cleaver', 'tconstruct:scythe', 'artifacts:everlasting_beef', 'artifacts:eternal_steak', 'artifacts:scarf_of_invisibility', 'immersiveengineering:windmill', 'immersiveengineering:watermill'];
